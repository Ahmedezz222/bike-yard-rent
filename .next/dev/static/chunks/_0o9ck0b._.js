...
function normalizePhone(value) {
    return String(value ?? "").trim().replace(/[\s()-]/g, "").replace(/^\+?0+/, "+").trim();
}
...
function toDashboardError(err, fallbackMessage) {
    ...
    if (raw.toLowerCase().includes("row-level security") || raw.toLowerCase().includes("permission denied") || raw.toLowerCase().includes("not allowed")) {
        return "Supabase policy blocks this action. Add an UPDATE policy for anon on public.customers.";
    }
...
function Dashboard() {
    ...
    const loadActiveRentals = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[loadActiveRentals]": async ()=>{
            ...
            try {
                ...
                setSubmitError("");
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].from("customers").select("id, created_at, name, phone, bike_id, customer_id, customer_id_image").eq("status", true).order("created_at", {
                    ascending: false
                });
    ...
    const loadAllCustomers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[loadAllCustomers]": async ()=>{
            ...
            try {
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].from("customers").select("id, created_at, name, phone, bike_id, customer_id, customer_id_image, status").order("created_at", {
                    ascending: false
                });
                if (error) throw error;
    ...
    const filteredAllCustomers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Dashboard.useMemo[filteredAllCustomers]": ()=>{
            if (!normalizedSearch) return allCustomers;
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: `rounded-full px-2 py-1 text-xs font-medium ${isActive ? "bg-emerald-900/30 text-emerald-300" : "bg-zinc-800 text-zinc-300"}`,
...
_s(Dashboard, "9IjwaxRNEUD1u+tSpVEs2vyiBQU=");
_c = Dashboard;
var _c;
...
//# sourceMappingURL=_0o9ck0b._.js.map