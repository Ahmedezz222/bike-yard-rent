...
function Dashboard() {
    ...
    const loadActiveRentals = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        ...
        try {
            ...
            setSubmitError("");
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].from("customers").select("id, created_at, name, phone, bike_id, customer_id, customer_id_image").eq("status", true).order("created_at", {
                ascending: false
            });
    ...
    const loadAllCustomers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        ...
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].from("customers").select("id, created_at, name, phone, bike_id, customer_id, customer_id_image, status").order("created_at", {
                ascending: false
            });
            if (error) throw error;
...
//# sourceMappingURL=_0-9iykd._.js.map